...
## Definición de Requisitos y casos de uso para Curso de Sistemas Embebidos
...
Cada factor recibió una puntuación del 1 al 10, siendo el valor 10 un indicador de la máxima condición favorable. Las ponderaciones fueron calculadas considerando dos dimensiones principales: primero, la conveniencia y factibilidad del proyecto dentro del marco del curso, y segundo, el impacto y valor potencial del proyecto tras su finalización.
...
- Aporte de nuevos conocimientos: se consideró el aporte de nuevas habilidades que el desarrollador aprenderá durante la realización del proyecto, siendo esta categoría un sinónimo de motivación.
...
En este caso el sistema de control de acceso es el cual lleva la delantera ya que es el más viable en términos de tiempo de implementación para el mismo en el marco del curso. El sistema de monitoreo de Temperatura y Humedad requeriría un tiempo algo mayor debido a que se deben estudiar los sensores que este sistema implementaría, además de necesitar hardware adecuado. Respecto al sistema de alarma de seguridad con detección de movimiento, si bien en este caso el hardware está disponible, se debería al igual que en el caso anterior estudiar las necesidades de software para implementar lo que demandaría más tiempo, del disponible.
...
En el mercado existen controles de acceso que pueden presentar otras características, en este caso se presentan 2 a modo comparativo.
...
| **Temperatura de Funcionamiento**     | -20  ºC – 60 ºC                                     | 0 ºC – 60 ºC                                           |
...
*Tabla 2: Comparación de productos comerciales*
...
| 005                     | Lectura de un sensor analógico (LDR).                             | Detecta la presencia de luz ambiente u oscuridad en el entorno.                                      |
